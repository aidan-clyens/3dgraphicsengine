...
/* Object3D
 */
Object3D::Object3D() : m_name("Object")
{
...
/* Object3D
 */
Object3D::Object3D(vec3 pos, vec3 rotation, vec3 size) : m_name("Object")
{
  // Initialize transform
...
Object3D *Object3DFactory::create_object()
{
  return new Object3D();
}

Object3D *Object3DFactory::create_object(vec3 position, vec3 rotation, vec3 size)
{
  return new Object3D(position, rotation, size);
}
